...
final class DialogHelper {
    ...
    // region Declarations
    AlertDialog mNewTransactionDialogObject;
    AlertDialog mEditTransactionDialogObject;
    AlertDialog mTransactionDetailsDialogObject;
    Context mContext;
    View mNewTransactionDialogView;
    Spinner mDataQuantitySpinner;
    UtilManager mManager;
    private Transaction mViewedTransaction;
    ...
    private void buildNewTransactionDialog() {
        mNewTransactionDialogView = LayoutInflater.from(mContext).inflate(R.layout.new_transaction_dialog, null, false);
        mDataQuantitySpinner = mNewTransactionDialogView.findViewById(R.id.data_quantity_spinner_new_transaction_dialog);
        ...
        newTransactionDialogBuilder.setView(mNewTransactionDialogView);
        final EditText etPhone = mNewTransactionDialogView.findViewById(R.id.et_phone_transaction_dialog);
        final EditText etAlias = mNewTransactionDialogView.findViewById(R.id.et_alias_new_transaction_dialog);
        final CheckBox paidCheckBox = mNewTransactionDialogView.findViewById(R.id.paid_checkBox);
        final String autoAlias = mManager.generateCustomerAlias();
        etAlias.setAutofillHints(autoAlias);

        Button submitButton = mNewTransactionDialogView.findViewById(R.id.btn_submit_new_transaction_dialog);
...
//        changeNameBuilder.setTitle("Change Room Name");
    ...
    void showTransactionDetails(Transaction transaction){
        mViewedTransaction = transaction;
