...
public class CustomerAdapter extends RecyclerView.Adapter<CustomerAdapter.ViewHolder> {
    ...
    private CardClickListeners mCardClickListeners;
    private Context mContext;

    CustomerAdapter(ArrayList<Customer> customers) {
    ...
    void setCardClickListeners(CardClickListeners cardClickListeners) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        ViewHolder(@NonNull ItemCustomerCardBinding binding) {
